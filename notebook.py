...
# 각 인자에 대한 정보를 추가
parser.add_argument("--question", type=str, required=True, help="Question for the AI")
parser.add_argument("--humidity", type=int, required=True, help="Humidity data")
parser.add_argument("--temp", type=int, required=True, help="Temperature data")
